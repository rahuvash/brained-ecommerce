    ...
    <div className="container mx-auto p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <p className="text-2xl font-bold text-primary-dark mb-6">${product.price}</p>
          ...
          {/* Add to Cart button */}
          <button className="bg-primary hover:bg-primary-dark text-white font-bold py-3 px-6 rounded-lg">
            Add to Cart
          </button>
        </div>
      </div>
